...
| `make:domain-migration` | Migration trong domain | `php artisan make:domain-migration Knowledge/create_tags_table` |
...
# Migration tạo bảng mới
php artisan make:domain-migration Knowledge/create_tags_table --create=tags

# Migration alter bảng có sẵn
php artisan make:domain-migration Knowledge/add_color_to_tags_table --table=tags
```
